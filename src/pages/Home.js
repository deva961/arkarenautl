...
import ServiceSvg from '../assets/images/svg/service.svg'
    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 max-w-4xl mx-auto my-6 xl:my-9 lg:px-0 px-5">
        ...
        <div className="col-span-1 border border-px py-3 flex items-center justify-center w-full">
          <Link to={"/renault-car-service-near-me"} className="flex items-center space-x-3">
            <img src={ServiceSvg} alt="book a service" className="h-8 w-8" loading="lazy" />
            <p className="text-xs font-bold">Book a service</p>
          </Link>
        </div>
      </div>
    </>
